...
public class SimpleActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 生成添加第一个子页面
		adapter.addPager("是否还在为一个人学习的困境所烦恼？");
		// 生成添加第二个子页面
		adapter.addPager("是否还在为自己的努力无人问津而苦恼？");
		// 生成添加第三个子页面
		adapter.addPager("是否还在为无法满足企业的要求而迷茫？");
		// 生成添加第四个子页面
		adapter.addPager("加入北风，成功，现在开始！");
		// 将适配器对象设入viewpager
	...
	public class SimpleAdapter extends PagerAdapter {
		...
		public void addPager(String text) {
			...
			holder.root = inflater.inflate(R.layout.pageitem_simple, null);
